...
export default {
  ...
  create(userStory) {
    return api
      .post(`/user-stories/`, userStory)
      .then((response) => response.data);
  },
  update(id, userStory) {
    return api
      .put(`/user-stories/${id}/`, userStory)
      .then((response) => response.data);
  },
  delete(id) {
  ...
  mover(id, estado) {
    return api
      .post(`/sprint-backlogs/${id}/mover/`, { estado_kanban: estado })
      .then((response) => response.data);
  },
  actividades(id) {
    return api
      .get(`/sprint-backlogs/${id}/actividades/`)
      .then((response) => response.data);
  },
  registrarActividad(actividad) {
    return api
      .post(`/actividades/`, actividad)
      .then((response) => response.data);
  },
